export const Obsession = {
    ...
    //Hero
    poster:"/Thumbnails/@Obsession_Thumbnail.png",
    releaseDate:"December 2023",
    studioName:"",
    teamSize:"4 Programmers and 3 Artists",
    platforms:"PC",
    responsiblities:[
        "Developed the Computer features"
    ],
    engine:"Unity",
    ...
    contributions:[
        `Developed the Computer features like Streaming, Making a Video and Upgrades`,
        `Implemented an outline on clickable objects that appears while hovering`,
    ],
